            ...
            <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    <select class="form-control" id="jenis_kelamin" name="jenis_kelamin" required>
                        <option value="L" <?= getSafeFormValue($show_dosen, 'jenis_kelamin') == 'L' ? 'selected' : '' ?>>Laki-laki</option>
                        <option value="P" <?= getSafeFormValue($show_dosen, 'jenis_kelamin') == 'P' ? 'selected' : '' ?>>Perempuan</option>
                    </select>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <option value="1" <?= isset($show_dosen['prodi_id']) && $show_dosen['prodi_id'] == '1' ? 'selected' : '' ?>>Teknik Informatika</option>
                    <option value="2" <?= isset($show_dosen['prodi_id']) && $show_dosen['prodi_id'] == '2' ? 'selected' : '' ?>>Sistem Informasi</option>
</div>
    </div>
